  ...
  <div class="content-wrapper container-xxl p-0">
    ...
    <div class="content-body">
      ...
      <section id="cotize_details">
            ...
            <form method="POST" enctype="multipart/form-data" id="create_income_details_form" class="row"
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-3">
                  <div>
                    ...
                    <input name="validez_oferta" type="text" placeholder="Validez de la Oferta" class="form-control"
                      required>
                  </div>
                </div>
              </div>
                    ...
                    <table class="table" id="add_products">
                      ...
                      <tfoot>
                        <tr>
                          ...
                          <th>
                            <h4 id="subtotal">0.00</h2><input type="hidden" name="ssubtotal" id="ssubtotal">
                          </th>
                        <tr>
                          <th style="height:2px;" colspan="3"></th>
                          <th colspan="">IGV</th>
                          <th>
                            <h4 id="totaligv">0.00</h2><input type="hidden" name="igv_total" id="igv_total">
                          </th>
                        </tr>
                        <tr>
                          <th style="height:2px;" colspan="3"></th>
                          ...
                          <th style="height:2px;">
                            <h4 id="totalimp">0.00</h4><input type="hidden" name="total_venta" id="total_venta">
                          </th>
              ...
              <div class="col-12">
                ...
                <button type="button" class="btn btn-secondary"
                  onclick="window.location.href='Cotize/index.php'">Cancelar</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="modal fade" id="create_income_product_modal" data-bs-backdrop="static" data-bs-keyboard="false"
          tabindex="-1">
